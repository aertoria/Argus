...
//        datapoints_2.put(hourstart, "1.0");
        ...
        List<Metric> expected = new ArrayList<Metric>();  
        Metric expected_metric1 = new Metric("SUM", "ImpactedMin");
        ...
        Metric expected_metric3 = new Metric("SUM", "Availability");
	...
	public void HeimdallTotalAvaTransform_IMPACT(){
        ...
        Metric expected_metric2 = new Metric("SUM", "CHI.SP2.cs15.Rac2");
        Map<Long, String> expected_Datapoints2=new HashMap<Long, String>();
	...
	public void HeimdallTotalAvaTransform_MISSINGAPT(){	
		Transform transform=injector.getInstance(HeimdallMetricReducer.class);
		int offset=1000*60;
		long start=0L;
		long hourstart=1000*3600L;
...
//        metrics.add(metric_6);    
	...
	@Test(expected = RuntimeException.class)
	public void HeimdallTotalAvaTransform_NOTRAFFIC(){
		Transform transform=injector.getInstance(HeimdallMetricReducer.class);
		int offset=1000*60;
		long start=0L;
        Metric metric_1 = new Metric(TEST_SCOPE, TEST_METRIC);
	...
	@Test(expected = RuntimeException.class)
	public void HeimdallTotalAvaTransform_NOAPT(){
		Transform transform=injector.getInstance(HeimdallMetricReducer.class);
		int offset=1000*60;
		long start=0L;
        Metric metric_1 = new Metric(TEST_SCOPE, TEST_METRIC);
        ...
        metric_1.setDatapoints(datapoints_1);
        metric_1.setTag("device", "na11-app1-1-chi.ops.sfdc.net");
        metric_1.setMetric("SFDC_type-Stats-name1-System-name2-trustAptRequestCountRACNode2.Last_1_Min_Avg");
        ...
        metric_2.setDatapoints(datapoints_2);
        metric_2.setTag("device", "na11-app1-2-chi.ops.sfdc.net");
        metric_2.setMetric("SFDC_type-Stats-name1-System-name2-trustAptRequestCountRACNode2.Last_1_Min_Avg");
	...
	@Test
	public void HeimdallTotalAvaTransform_COLLECTED(){
		Transform transform=injector.getInstance(HeimdallMetricReducer.class);
		int offset=1000*60;
		long start=0L;
        Metric metric_1 = new Metric(TEST_SCOPE, TEST_METRIC);
        ...
        metrics.add(metric_6);
        //metrics.add(metric_7);        
        List<Metric> result = transform.transform(metrics,Arrays.asList("COLLECTED"));
        ...
        Metric expected_metric2 = new Metric("SUM", "CHI.SP2.cs15.Rac2");
        Map<Long, String> expected_Datapoints2=new HashMap<Long, String>();
        expected_Datapoints2.put(0L, "6.0");
        expected_metric2.setDatapoints(expected_Datapoints2);
        expected.add(expected_metric2);
